...
[![CI](https://github.com/peguesj/ag_ui/actions/workflows/ci.yml/badge.svg)](https://github.com/peguesj/ag_ui/actions/workflows/ci.yml)
[![Hex.pm](https://img.shields.io/hexpm/v/ag_ui.svg)](https://hex.pm/packages/ag_ui)
...
Add `ag_ui` to your dependencies in `mix.exs`:
